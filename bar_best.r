...
boxplot(boxbest,xlab="Model",xaxt='n',ylab="Accuracy",ylim=c(0.92,1), main="Box Plot Accuracy",col="aquamarine2")
...
boxplot(boxbest,xlab="Model",xaxt='n',ylab="Recall",ylim=c(0.92,1), main="Box Plot Precision",col="azure3")
axis(1, at=1:3, labels=c("KNN - 1","BDT Depth - 11", "Alpha - 0.01"))
dev.off()
